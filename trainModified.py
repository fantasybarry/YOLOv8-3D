...
label_dir = '/home/lintan/BEV/TestData/kitti/training/label_2/'
image_dir = '/home/lintan/BEV/TestData/kitti/training/prev_2/'
...
if __name__ == '__main__':
    ...
    checkpoint  = ModelCheckpoint('./'+select_model+'/'+select_model+'.weights.h5', monitor='val_loss', verbose=1, save_best_only=True, save_weights_only = True)
    ...
    weights_path = './'+select_model+'/'+select_model+'.weights.h5'
    ...
    if os.path.exists(weights_path):
        ...
        print(model.summary())
        print('loading file ...'+select_model+'.weights.h5...!')
    else:
        print('The file '+select_model+'.weights.h5 does not exist ..starting form epoch 1.')
    ...
    full_model_path = f'./{select_model}/{select_model}_full.h5'
    model.save(full_model_path)
    print(f"\n✅ Saved FULL model for prediction at: {full_model_path}")
